...
**TODO** Try plotting some with other diversification parameters. What happens if speciation rate is much higher than extinction rate? 
...
legend("topleft", legend=c("b=0.3,d=0.6", "b=0.5,d=0.4"), fill=colors)
