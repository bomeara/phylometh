...
```{r, eval=TRUE}
# four is the OUMV model. my best model was BM1
require("akima")
nreps<-400
...
* The best model (BM1) does perform better if the models can be compared. I am not sure about that as i do not fully understand what the tree mapping does. AIC values are only comparable if the same data is used. There is no data added, as far as I can tell.
